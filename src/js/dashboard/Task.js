            ...
            <div className='icon-panel'>
              {
                ...
                ? <div>
                    ...
                    <div style={{fontSize:'14px', color:'#FF0000'}}>{differenceInHours(new Date(this.props.task.dueDate).getTime(), new Date().getTime())}h&nbsp;
                      {differenceInMinutes(new Date(this.props.task.dueDate).getTime(), new Date().getTime()) % 60}m</div>
                  </div>
                : this.props.task.severity == "HIGH"
                ? <div> 
                    <div style={{color:'#FF7A2F', fontSize:'14px', fontWeight:'bold'}}> 
                    ...
                    <div style={{fontSize:'14px', color:'#FF7A2F'}}>{differenceInHours(new Date(this.props.task.dueDate).getTime(), new Date().getTime())}h&nbsp;
                      {differenceInMinutes(new Date(this.props.task.dueDate).getTime(), new Date().getTime()) % 60}m</div>
                  </div>
                : this.props.task.severity == 'NORMAL'
                ? <div> 
                    <div style={{color:'#17F1D7', fontSize:'14px', fontWeight:'bold'}}> 
